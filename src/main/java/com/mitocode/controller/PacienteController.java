...
import com.mitocode.model.AjaxResponseBody;
...
public class PacienteController {
	...
	public ResponseEntity<AjaxResponseBody> registrar(@Valid @RequestBody Paciente paciente){
		AjaxResponseBody resultAjax = new AjaxResponseBody();
		Paciente pac = new Paciente();
		pac = service.registrar(paciente);
		resultAjax.setCode(pac.getIdPaciente());
